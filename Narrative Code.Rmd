...
## testing prediction accuracy of all three models in turn (fill in model name for different calculations)
...
sig_step_mod <- glm(over_avg_rx_rate ~ unemployment_rate + hs_graduation_rate + average_age + no_hispanic_proportion + state_legislature + poverty_rate, data = step_test, family = "binomial")
