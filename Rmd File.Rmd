...
fit_log_reg = glm(over_avg_rx_rate ~ unemployment_rate +
                    hs_graduation_rate,
                  data=working_data,
                  family = binomial)
summary(fit_log_reg)
